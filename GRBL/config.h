...
#define AUX_PIN		PINC
#define AUX_DDRVAL 	0x19     // DDR init value, all 0s become inputs with pullups
#define AUX_COUNTER_RESET 0  // External counter reset, used with M100 command
#define AUX_16_BIT 1         // Tool length input AUX_16
#define AUX_17_BIT 2
#define AUX_WDOG_BIT 3       // Activity monitor square wave
#define AUX_SERVO_BIT 4
#define AUX_STOP_BIT 5
#define AUX_INVMASK 0x00     // $20 for mechaStep/WinPC-NC compatible HW, $00 for Mach3

// Switch Report on "%" character:
// Bit 0 = X Limit (+1)  X_LIMIT_BIT
// Bit 1 = Y Limit (+2)  Y_LIMIT_BIT
// Bit 2 = Z Limit (+4)  Z_LIMIT_BIT
// Bit 3 = Aux_16  (+8)  AUX_16_BIT
